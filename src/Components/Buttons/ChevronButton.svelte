<script lang="ts">
    ...
    {
        button.classList.toggle("chevron-close");
...
<button bind:this={button} class="aspect-square h-8 fill-text transition-transform duration-200 ease-in-out" on:click={buttonClick}>
